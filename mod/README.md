...
- S-70C(M) SH-60 visual prototype livery, serial, and emblem assets: `assets/rocn/aircraft/s-70cm/` (neutral gray test livery; detailed ROCN markings still need SH-60 UV cleanup)
